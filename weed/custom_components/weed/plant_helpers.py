...
class PlantHelper:
    ...
    async def generate_configentry(self, config: dict) -> dict[str:Any]:
        ...
        max_water = DEFAULT_MAX_WATER
        min_water = DEFAULT_MIN_WATER
        ...
        if opb_plant:
            ...
            max_water = opb_plant.get(
                CONF_PLANTBOOK_MAPPING[CONF_MAX_WATER], DEFAULT_MAX_WATER
            )
            min_water = opb_plant.get(
                CONF_PLANTBOOK_MAPPING[CONF_MIN_WATER], DEFAULT_MIN_WATER
            )
        ...
        ret = {
            ...
            FLOW_PLANT_INFO: {
                ...
                ATTR_PLANT_LASTFED: config.get(ATTR_PLANT_LASTFED) or datetime.now(),
                ATTR_PLANT_LASTWATERED: config.get(ATTR_PLANT_LASTWATERED) or datetime.now(),
                ATTR_PLANT_BIRTH: config.get(ATTR_PLANT_BIRTH) or datetime.now(),
                ATTR_PLANT_PLANTER: config.get(ATTR_PLANT_PLANTER) or 1,
                ATTR_PLANT_STRAIN: config.get(ATTR_PLANT_STRAIN) or "",
                ...
                ATTR_LIMITS: {
                    ...
                    CONF_MAX_WATER: config.get(CONF_MAX_WATER, max_water),
                    CONF_MIN_WATER: config.get(CONF_MIN_WATER, min_water),
                ...
                FLOW_SENSOR_WATER: config[ATTR_SENSORS].get(ATTR_WATER),
